...
const Details = props => {
  const { category, detail, OPEN_POPUP_DETAIL, ADD_TO_CART } = props;

  const addToCartHandle = () => {
    ADD_TO_CART(detail._id, {
      imageName: detail.image,
      footballName: detail.name,
      price: detail.price,
      sizes: detail.sizes,
    ...
    toast.success(
      `Added ${detail.name} of Rs.${detail.price} to cart successfully.`
    );
  };
    ...
    <div className="Details">
      <div className="Details__card">
        <div className="Details__card--left">
          <img
            src={`/images/league/${category}/${detail.image}`}
            alt={detail.name}
          ></img>
        </div>
        <div className="Details__card--right">
          <div
            ...
            onClick={() => OPEN_POPUP_DETAIL('close', null)}
          >
            <div>
          ...
          <div className="status">
            <div className="active">
              {detail.inStock ? 'InStock' : 'Out of Stock'}
            </div>
            <div>
              {detail.inStock ? 'Currently available' : 'Not available'}
            </div>
          </div>
          <div className="brand">
          ...
          <div className="sizes">
            ...
            <div className="sizes__size">
              {detail.sizes.map(el => {
                return (
                  <div className="sizes__box" key={el}>
                    {el}
                  </div>
                );
              })}
          ...
          <div className="button">
            <Solidbutton
              ...
              content="Add to cart"
              icon={<ion-icon name="cart-sharp"></ion-icon>}
            />
          </div>
        </div>
      </div>
