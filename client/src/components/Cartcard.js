  ...
  return (
    <div className="Cartcard">
      ...
      <div className="Cartcard__middle">
        <div className="Cartcard__name">{name}</div>
        <div>
          <div className="Cartcard__price">Rs {initialPrice}</div>
          <div className="Cartcard__price">total: Rs {price}</div>
        </div>

        <div className="Cartcard__sizes">
          sizes{' '}
          <div
            className="sizes__card"
            id={selectedSize === 3 ? 'active' : ''}
            onClick={() => setSize(3)}
          >
            3
          </div>
      ...
      <div className="Cartcard__right">
        ...
        <div className="Cartcard__quantity">
          <div
            className="Cartcard__increase"
            onClick={() => setQuantityIncrement()}
          >
            <ion-icon name="chevron-up-outline"></ion-icon>
          </div>
          <div className="Cartcard__quantityBox">{quantitys}</div>
          <div
            className="Cartcard__decrease"
            onClick={() => setQuantityDecrement()}
          >
...
export default connect(null, { UPDATE_CART, DELETE_CART, UPDATE_CART_SIZE })(
  Cartcard
);
